!(function (e, t) {
    ...
    function n(i, r) {
        ...
        return y(function () {
            if (
                (null != p.deprecationHandler && p.deprecationHandler(null, i),
                a)
            ) {
    ...
    function be(e, t) {
        ...
        var n = ((t % 12) + 12) % 12;
        return (
            (e += (t - n) / 12), 1 == n ? (j(e) ? 29 : 28) : 31 - ((n % 7) % 2)
        );
    }
    ...
    function Pt(e) {
        ...
        (this._isValid = (function (e) {
            ...
            for (t in e)
                if (
                    v(e, t) &&
                    (-1 === ge.call(Nt, t) || (null != e[t] && isNaN(e[t])))
                )
                    return !1;
    ...
    function Ft(e, t) {
        ...
        return t._isUTC
            ? ((n = t.clone()),
              (s =
                  (Y(e) || m(e) ? e.valueOf() : Ot(e).valueOf()) - n.valueOf()),
                ...
                for (
                    var n = (function (e) {
                            var t,
                                n = [];
                            for (t in e)
                                v(e, t) && n.push({ unit: t, priority: E[t] });
                            return (
                                n.sort(function (e, t) {
        ...
        (yn.eraYear = function () {
            for (
                ...
                if (
                    ...
                    return (
                        (this.year() - p(n[s].since).year()) * e + n[s].offset
                    );
            return this.year();
        }),
        (yn.year = Fe),
