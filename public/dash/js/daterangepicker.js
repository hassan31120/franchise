    ...
    function i(t, e, a) {
        ...
        if (
            (void 0 === e.startDate &&
                ...
                ((o = i = null),
                2 ==
                (r = (n = R(this.element).val()).split(this.locale.separator))
                    .length
                    ? ((o = j(r[0], this.locale.format)),
                      (i = j(r[1], this.locale.format)))
                    : this.singleDatePicker &&
                      "" !== n &&
                      ((o = j(n, this.locale.format)),
                      (i = j(n, this.locale.format))),
                null !== o &&
                    null !== i &&
                    (this.setStartDate(o), this.setEndDate(i))),
            ...
            for (s in e.ranges) {
                ...
                this.maxSpan &&
                    ...
                    (this.minDate &&
                        ...
                        (d &&
                            o.isAfter(d, this.timepicker ? "minute" : "day")) ||
                        (((l = document.createElement("textarea")).innerHTML =
                            s),
                        (c = l.value),
                        (this.ranges[c] = [o, i]));
        ...
        (i.prototype = {
            ...
            renderCalendar: function (t) {
                ...
                if (this.showDropdowns) {
                    ...
                    B += "</select>";
                    for (
                        var L = '<select class="yearselect">', N = M;
                        N <= x;
                        N++
                    )
                        L +=
            ...
            move: function () {
                ...
                this.container.toggleClass("drop-up", "up" == a),
                    "left" == this.opens
                        ...
                        : (n = this.element.offset().left - e.left) + r >
                          R(window).width()
                    ...
                    this.endDate ||
                        this.container
                            ...
                            .each(function (t, e) {
                                var a, i, s, n;
                                R(e).hasClass("week") ||
                                    ((i = (a = R(e).attr("data-title")).substr(
                                        1,
                                        1
                                    )),
                                    (s = a.substr(3, 1)),
            ...
            elementChanged: function () {
                ...
                this.element.is("input") &&
                    ...
                    ((a = e = null),
                    2 ===
                        (t = this.element.val().split(this.locale.separator))
                            .length &&
