!(function (t) {
    ...
    function t(t, e) {
        return function () {
            return (
                e !== V && x.fn.datepicker.deprecated(e),
    ...
    k.prototype = {
        ...
        _buildEvents: function () {
            var t = {
                keyup: x.proxy(function (t) {
                    -1 ===
                        x.inArray(t.keyCode, [27, 37, 39, 38, 40, 32, 13, 9]) &&
                        this.update();
                }, this),
        ...
        paste: function (t) {
            ...
            if (
                ...
                -1 !==
                    x.inArray("text/plain", t.originalEvent.clipboardData.types)
            )
        ...
        setUTCDates: function () {
            var t = x.isArray(arguments[0]) ? arguments[0] : arguments;
            return (
                this.setDates.apply(this, x.map(t, this._utc_to_local)), this
            );
        },
        setDate: t("setDates"),
            ...
            return (
                ...
                this.range &&
                    (t > this.range[0] &&
                        ...
                        e.push("range"),
                    -1 !== x.inArray(t.valueOf(), this.range) &&
                        e.push("selected"),
        ...
        fill: function () {
            ...
            if (!isNaN(s) && !isNaN(a)) {
                ...
                var D = new Date(f);
                f.getUTCFullYear() < 100 &&
                    D.setUTCFullYear(f.getUTCFullYear()),
                ...
                for (var m, y, v, w, k, b, _ = []; f.valueOf() < D; ) {
                    (m = f.getUTCDay()) === this.o.weekStart &&
                        ...
                        ((v = new Date(
                            +f + ((this.o.weekStart - m - 7) % 7) * 864e5
                        )),
                        (w = new Date(
        ...
        navArrowsClick: function (t) {
            ...
            0 !== this.viewMode &&
                (e *= 12 * N.viewModes[this.viewMode].navStep),
    ...
    var A = (x.fn.datepicker.dates = {
        ...
        N = {
            ...
            formatDate: function (t, e, i) {
                if (!t) return "";
                if (
                    ("string" == typeof e && (e = N.parseFormat(e)),
                    e.toDisplay)
                )
