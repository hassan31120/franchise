    ...
    (c.prototype = {
        ...
        getLuminance: function () {
            ...
            return (
                0.2126 *
                    (e <= 0.03928
                        ? e / 12.92
                        : u.pow((0.055 + e) / 1.055, 2.4)) +
                0.7152 *
                    (r <= 0.03928
                        ? r / 12.92
                        : u.pow((0.055 + r) / 1.055, 2.4)) +
                0.0722 *
                    (n <= 0.03928 ? n / 12.92 : u.pow((0.055 + n) / 1.055, 2.4))
            );
        },
        setAlpha: function (t) {
            return (
                (this._a = v(t)), (this._roundA = M(100 * this._a) / 100), this
            );
        },
        toHsv: function () {
        ...
        (c.isReadable = function (t, e, r) {
            ...
            switch (
                ("AA" !==
                    (i = (
                        (a = (a = r) || { level: "AA", size: "small" }).level ||
                        "AA"
                    ).toUpperCase()) &&
                    "AAA" !== i &&
                    (i = "AA"),
