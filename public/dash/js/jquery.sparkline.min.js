    ...
    (t = function (L) {
        ...
        (L.SPFormatClass = m =
            ...
            (p = function (t, e, i, s, r) {
                ...
                for (
                    t = (
                        !1 === e ? parseFloat(t).toString() : t.toFixed(e)
                    ).split(""),
                        (n = (n = L.inArray(".", t)) < 0 ? t.length : n) <
                            t.length && (t[n] = r),
                        a = n - i;
                    0 < a;
                    a -= i
            ...
            (u = R({
                ...
                registerCanvas: function (t) {
                    var e = L(t.canvas);
                    (this.canvas = t),
                        (this.$canvas = e).mouseenter(
                            L.proxy(this.mouseenter, this)
                        ),
                ...
                reset: function (t) {
                    (this.splist = []),
                        this.tooltip &&
                            t &&
                            (this.tooltip.remove(), (this.tooltip = N));
                },
            ...
            (e = R({
                ...
                updateWindowDims: function () {
                    (this.scrollTop = L(window).scrollTop()),
                        ...
                        (this.scrollRight =
                            this.scrollLeft + L(window).width()),
                        this.updatePosition();
                },
                getSize: function (t) {
                        ...
                        e = function () {
                            var t,
                                ...
                                a =
                                    "auto" === h.get("width")
                                        ? n.length *
                                          h.get("defaultPixelsPerValue")
                                        : h.get("width");
                            "auto" === h.get("height")
                                ? (h.get("composite") &&
                                      L.data(this, "_jqs_vcanvas")) ||
                                  (((e = S.createElement("span")).innerHTML =
                                      "a"),
                                  o.html(e),
            ...
            (L.fn.sparkline.options = R({
                ...
                getTagSetting: function (t) {
                    ...
                    if (this.tagValCache.hasOwnProperty(t))
                        ...
                        if (
                            (e = this.tag.getAttribute(n + t)) === N ||
                            null === e
                        )
                            e = v;
                        else if ("[" === e.substr(0, 1))
                            for (
                                i = (e = e.substr(1, e.length - 2).split(","))
                                    .length;
                                i--;
            ...
            (L.fn.sparkline._base = R({
                ...
                calcHighlightColor: function (t, e) {
                    ...
                    if (
                        ...
                        for (
                            r = [], s = 4 === t.length ? 16 : 1, n = 0;
                            n < 3;
                            n++
                        )
                            r[n] = A(
                                z.round(parseInt(i[n + 1], 16) * s * h),
                                0,
                                255
                            );
                        return "rgb(" + r.join(",") + ")";
                ...
                R(L.fn.sparkline._base, i, {
                    ...
                    init: function (t, e, i, s, r) {
                        var n,
                            ...
                            T = -1 / 0;
                        for (
                            X._super.init.call(this, t, e, i, s, r),
                                j = 0,
                                P = e.length;
                            j < P;
                            j++
                        ...
                        (this.max = d = z.max.apply(z, l)),
                            ...
                            i.get("chartRangeMin") !== N &&
                                (i.get("chartRangeClip") ||
                                    i.get("chartRangeMin") < c) &&
                                (c = i.get("chartRangeMin")),
                            i.get("chartRangeMax") !== N &&
                                (i.get("chartRangeClip") ||
                                    i.get("chartRangeMax") > d) &&
                            ...
                            (this.xaxisOffset = u),
                            (g = m
                                ? z.max.apply(z, o) + z.max.apply(z, I)
                                : d - c),
                            (this.canvasHeightEf =
                                p && c < 0
                                    ? this.canvasHeight - 2
                            ...
                            c < u
                                ? (R =
                                      (((m && 0 <= d ? T : d) - u) / g) *
                                      this.canvasHeight) !== z.ceil(R) &&
                                  ((this.canvasHeightEf -= 2), (R = z.ceil(R)))
                                : (R = this.canvasHeight),
                            (this.yoffset = R),
                    ...
                    render: function () {
                        ...
                        if (w._super.render.call(this)) {
                            if (d.get("raw"))
                                ...
                                for (t = a = N, o = 0; o < c; o++)
                                    t === N &&
                                        u[o] > s - i * d.get("outlierIQR") &&
                                        (t = u[o]),
                                        u[o] < n + i * d.get("outlierIQR") &&
                                            (a = u[o]);
                                (e = u[0]), (h = u[c - 1]);
                            } else (t = u[0]), (a = u[c - 1]);
            ...
            (c = R(r, {
                ...
                replaceWithShapes: function (t, e) {
                    for (
                        var i, s, r = this.shapeseq, n = {}, a = t.length;
                        a--;
                    ...
                    for (a = r.length; a--; )
                        n[(i = r[a])] &&
                            (r.splice(a, 1), delete this.shapes[i], (s = a));
                    for (a = e.length; a--; )
